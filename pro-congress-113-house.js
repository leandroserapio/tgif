...
function funcionMostrar(dataHouse){
  
  var houses = dataHouse.results[0].members
  var tabla = document.getElementById("tablaHouse")
  var paraElHtml = houses.map((house)=>{
      if (house.middle_name == null) {
          return "<tr><td><a href='" + house.url + "' target='_blank'>" + house.first_name + " " + house.last_name + "</a></td><td>" + house.party + "</td><td>" + house.seniority + "</td><td>" + house.state + "</td><td>" + house.votes_with_party_pct + " %</td></tr>";     
      } else {
          return "<tr><td><a href='" + house.url + "' target='_blank'>" + house.first_name + " " + house.middle_name + " " +house.last_name + "</a></td><td>" + house.party + "</td><td>" + house.seniority + "</td><td>" + house.state + "</td><td>" + house.votes_with_party_pct + "%</td></tr>"; 
      }
});
