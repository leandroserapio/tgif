...
fetch("https://api.propublica.org/congress/v1/113/senate/members.json",{
    method: "GET",
    headers: new Headers({
        "X-API-Key": 'AqEE4Iq5NO0GgIk2dqHevog1qJ6V7LzSl2xJGEb0'
    }),
...
function funcionMostrar(dataSenate){
  
    var senadores = dataSenate.results[0].members
    var tabla = document.getElementById("tablaSenadores")
    var paraElHtml = senadores.map((senador)=>{
        if (senador.middle_name == null) {
            return "<tr><td><a href='" + senador.url + "' target='_blank'>" + senador.first_name + " " + senador.last_name + "</a></td><td>" + senador.party + "</td><td>" + senador.seniority + "</td><td>" + senador.state + "</td><td>" + senador.votes_with_party_pct + " %</td></tr>";     
        } else {
            return "<tr><td><a href='" + senador.url + "' target='_blank'>" + senador.first_name + " " + senador.middle_name + " " +senador.last_name + "</a></td><td>" + senador.party + "</td><td>" + senador.seniority + "</td><td>" + senador.state + "</td><td>" + senador.votes_with_party_pct + "%</td></tr>"; 
        }
});

    console.log(paraElHtml);
    tabla.innerHTML = paraElHtml.join("");

    console.log(senadores);
}
funcionMostrar(dataSenate);
